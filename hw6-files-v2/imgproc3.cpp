...
// Usage: myimgproc in_file_name.jpg out_file_name.jpg
...
int main(int argc, char* arvg[])
{
  ...
  */
  ...
  if (!image_in)
  {
    printf("Error: Can't allocate memoery!\n");
    return(1);
  }
  ...
  */
  ...
  bool isSuccess = imwrite(argv[2], M_out); //write image to file as JPEG
  //bool isSuccess = imwrite("MyOutputImage.png", M_out); //write image to file as PNG
  if (isSuccess == false)
  {
